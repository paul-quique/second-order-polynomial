...
public class SecondOrderPolynomial {
	...
	public SecondOrderPolynomial(double a, double b, double c, int startNumber, double r) {
		this.a = a;
		this.b = b;
		this.c = c;
	...
	public int calculate(double x) {
		...
		result = (int) ((a*Math.pow(x, 2) + b*x + c) - r); //this will calculate the result of x by the function
